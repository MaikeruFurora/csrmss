...
class MassController extends Controller
{
    ...
    public function registerCreate(RegisterService $regiterservice){
        ...
        $data =Mass::select('register_services.*','clients.*','masses.*')->join('register_services','masses.register_service_id','register_services.id')
    ...
    public function store(Request $request){
        if (isset($request->id)) {
            ...
            if (!$this->check_time_overlap($request->scheduled_time_form, $request->scheduled_time_to, $myTime)) {
                 return Mass::whereId($request->id)->update([
