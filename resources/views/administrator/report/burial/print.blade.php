    ...
    <div class="containers content2">
        <p class="headerr">
            ...
            <div style="text-align: center">
                <img src="{{ asset('asset/img/logo.png') }}" width="15%">
                <h3 style="margin-top: 50px"><u><b>CERTIFICATE OF DEATH</b></u></h3>
                <h4 style="margin-top: 50px"><u><b>-o0o- THIS IS TO CERTIFY -o0o- </b></u></h4>
                <p style="margin-top: 50px;font-size:18px;text-transform:" class="">
                    That born at <b><u>{{ $burial->burial_birth_of_date }}</u></b> on the . Died at on the <b><u>{{ $burial->burial_date_died }}</u></b> and was buried with the rites of The Roman Catholic Church in The Roman Catholic Church in St. Paul the Apostle Parish as it appears from the Death Register of this Church.
                </p>
                 <br><br>
