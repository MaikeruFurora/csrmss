...
<section class="section">
    <h2 class="section-title">Report Mass</h2>
                ...
                <div class="card card-primary">
                    <div class="card-header">
                       <div class="card-header-action">
                        {{-- <div class="btn"> --}}
                            <a href="{{ route('admin.mass.create') }}" class="btn btn-info delete">SHEDULE MASS</a>
                        ...
                        <div class="tab-content tab-bordered" id="myTab3Content">
                            <div class="tab-pane fade show active" id="home2" role="tabpanel" aria-labelledby="home-tab2">
                               <div class="table-responsive">
                                <table style="font-size:10px" class="table table-bordered table-striped" id="massTablePending">
                                    <thead>
                                        <tr>
                                           <th>Fullname</th>
...
$("#btnGenerate").on('click',function(e){
        ...
        $("#generatePDF").submit(function(e){
            ...
            if (to!="") {
                window.open(`mass/pdf/${from}/${to}`,'_blank')
                $("input[name='from']").val('');
                $("input[name='to']").val('');
            }else{
    ...
    let massTablePending = $("#massTablePending").DataTable({
        pageLength: 5,
        lengthMenu: [ 5,10, 25, 50, 75, 100 ],
        destroy: true,
        ajax: "/admin/report/mass/pending",
        columns: [
            {
                 data: null,
    ...
    let burialTableApproved= $("#burialTableApproved").DataTable({
        ...
        lengthMenu: [ 5,10, 25, 50, 75, 100 ],
        destroy: true,
        ajax: "/admin/report/mass/approved",
        columns: [
            {
                 data: null,
                 render:function(data){
                ...
                },
            {
                 ...
                 render:function(data){
                    ...
                    <a href="/admin/report/mass/view/${data.id}" class="btn btn-sm btn-info view pl-4 pr-4">View</a>
                    `;
    ...
    $(".yesConfirm").on('click',function(){
        $.ajax({
            url: "/admin/report/mass/delete/" + $(this).val(),
            type: "DELETE",
    ...
    $(".yesApproved").on('click',function(){
        ...
        $.ajax({
            url: "/admin/report/mass/change/status/"+data[0]+"/"+data[1],
            type: "POST",
            data: { _token: $('input[name="_token"]').val() },
            beforeSend: function () {
                $(".yesApproved").html(`
    ...
    $(document).on("click",'.print', function () {
        ...
        $(".generate").on('click',function(){
            let priest = $("select[name='priest']").val()
             ...
             popupCenter({
                    url: "/admin/report/mass/print/" + $(this).val()+"/"+priest,
                    title: "report",
                    w: 1400,
                    h: 800,
                });
