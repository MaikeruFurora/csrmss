        ...
        <div class="modal-dialog modal-md modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body pb-0">
                        ...
                        <textarea name="bodyEmail" class="summernote-simple"  data-height="20" required></textarea>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-success btnSendEmail pl-4 pr-4" ><i class="far fa-paper-plane"></i> Send</button>
