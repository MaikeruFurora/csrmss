                          ...
                          <input type="hidden" name="id" value="{{ $data->id }}">
                            ...
                            <div class="form-row">
                              ...
                              <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control"   name="bride_middle_name" value="{{ $data->bride_middle_name ?? '' }}">
                              </div>
                              <div class="col-md-3 mb-3">
                            ...
                            <div class="form-row">
                              ...
                              <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control"   name="groom_middle_name" value="{{ $data->groom_middle_name ?? '' }}">
                              </div>
                              <div class="col-md-3 mb-3">
